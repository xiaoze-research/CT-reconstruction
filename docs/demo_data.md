...
Flat-field and dark-field reference images are not included. A prior local
reconstruction used a horizontal center correction of approximately +30
detector pixels; the public command below does not apply that correction
automatically, so centering and artifact levels may differ.
